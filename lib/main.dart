...
void main() async{
  ...
  var exchangeData = json.decode(
      (await http.get(Uri.parse("https://api.coincap.io/v2/rates"))).body
  )["data"];
                ...
                children: [
                  GestureDetector(
                      child: Container(
                        ...
                        child: Image.asset("icon/icon_512X512.png"),
                      ),
                      onTap: () async{
                        String url = "https://kazungudev.github.io/kazungudev/#/";
                  ...
                  ListTile(
                      ...
                      onTap: () async{
                        String url = Uri.encodeFull("mailto:kazungudev@gmail.com?subject=GetPass&body=Contact Reason: ");
                        if(await canLaunch(url)) {
                          await launch(url);
                        }
                      }
                      ...
                      Expanded(child: Column(
                          ...
                          children: [
                            ...
                            Row(
                                children: [
                                  FadeInImage(
                                      image: !blacklist.contains(widget.id)?NetworkImage("https://static.coincap.io/assets/icons/${shortName.toLowerCase()}@2x.png"):AssetImage("icon/icon_1024X1024.png"),
                                      placeholder: AssetImage("icon/icon_1024X1024.png"),
...
class _SimpleTimeSeriesChartState extends State<SimpleTimeSeriesChart> {
  ...
  void initState(){
    ...
    http.get(Uri.parse("https://api.coincap.io/v2/assets/${widget.id}/history?interval="+widget.period+"&start="+now.subtract(Duration(days:widget.startTime)).millisecondsSinceEpoch.toString()+"&end="+now.millisecondsSinceEpoch.toString())).then((value){
